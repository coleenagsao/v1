                                ...
                                <div className="pt-4 flex flex-col ml-4">
                                    ...
                                    <div className="flex flex-wrap pt-3.5 pl-9">
                                        {item.skills.map((item) => (
                                            <div key={item} className="mr-3 w-max relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-blue-900 hover:ring-gray-100/20 text-center flex items-center justify-center">
